...
Source0  : https://cpan.metacpan.org/authors/id/O/OA/OALDERS/libwww-perl-6.73.tar.gz
...
%prep
%setup -q -n libwww-perl-6.73
cd %{_builddir}/libwww-perl-6.73
pushd ..
cp -a libwww-perl-6.73 buildavx2
popd
