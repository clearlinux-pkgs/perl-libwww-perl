...
Source0  : https://cpan.metacpan.org/authors/id/O/OA/OALDERS/libwww-perl-6.74.tar.gz
...
%prep
%setup -q -n libwww-perl-6.74
cd %{_builddir}/libwww-perl-6.74
pushd ..
cp -a libwww-perl-6.74 buildavx2
popd
