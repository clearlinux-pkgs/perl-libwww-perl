...
%prep
%setup -q -n libwww-perl-6.66
cd %{_builddir}/libwww-perl-6.66
...
cp %{_builddir}/libwww-perl-6.66/LICENSE %{buildroot}/usr/share/package-licenses/perl-libwww-perl/5816a49d54f43b60fe3caaa9b79f327c060f646e
if test -f Makefile.PL; then
