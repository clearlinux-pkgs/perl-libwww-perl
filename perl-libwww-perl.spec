...
Source0  : https://cpan.metacpan.org/authors/id/O/OA/OALDERS/libwww-perl-6.41.tar.gz
...
%prep
%setup -q -n libwww-perl-6.41
cd %{_builddir}/libwww-perl-6.41
...
cp %{_builddir}/libwww-perl-6.41/LICENSE %{buildroot}/usr/share/package-licenses/perl-libwww-perl/e9330dd55cc5b12a4e89bca611863182e2acf7d1
if test -f Makefile.PL; then
